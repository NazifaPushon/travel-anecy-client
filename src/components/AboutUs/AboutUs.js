...
const AboutUs = () => {
    return (
        <div className="aboutUs text-gray-100 mt-20 py-10" id="aboutUs">
            <div className="container">
                ...
                <div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center my-5">
                        ...
                        <div>
                            <p className="text-gray-100">HOLYDAY HYPE is a travel agency that makes our tour and travel a lot more easier.
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                        <Statistic icon={faCommentsDollar} title="AFFORDABLE PRICE" text="We give our services at the monst cheap rete"/>

                        <Statistic icon={faMapMarked} title="BEST DESTINATION" text="We have a great collection of intersting tour"/>

                        <Statistic icon={faUserTie} title="PERSONAL SERVICE" text="Our professional service will make you happy"/>
                    </div>
                </div>
            </div>
        </div>
